...
const tasks = [
  { title: "Mark JSS 2A assignment", meta: "38 submissions · due today", tone: "urgent", href: "/teacher/assignments" },
  { title: "Submit week 6 lesson plan", meta: "Mathematics · due tomorrow", tone: "warn", href: "/teacher/lesson-plans" },
    ...
    <main className="teacher-shell">
      <aside className="teacher-sidebar">
        ...
        <nav className="teacher-nav">
          {nav.map((item) => (
            <Link key={item.href} href={item.href} className={item.label === "Dashboard" ? "active" : ""}>
              <span className="nav-dot" />
              {item.label}
              {item.label === "Teacher AI" && <em>AI</em>}
            </Link>
          ))}
        </nav>
        ...
        <div className="teacher-content">
          <section className="teacher-welcome">
            ...
            <div className="teacher-quick-actions">
              ...
              <Link href="/teacher/lesson-plans" className="secondary">Create lesson plan</Link>
            </div>
          </section>
          ...
          <section className="teacher-ai-brief">
            ...
            <div>
              ...
              <div className="ai-buttons"><Link href="/teacher/ai">View recommendations</Link><Link href="/teacher/ai">Ask Teacher AI</Link></div>
            </div>
          </section>
          ...
          <section className="teacher-grid two-one">
            <Panel title="Today's timetable" subtitle="Your teaching schedule for today">
              ...
              <Link className="panel-link" href="/teacher/timetable">Open full timetable →</Link>
            </Panel>
          ...
          <section className="teacher-grid equal">
            <Panel title="My classes" subtitle="Class size, next lesson and curriculum progress">
              <div className="class-cards">
                {classes.map((item) => <article key={item.name} className="class-card">
                  ...
                  <footer><span>Next: {item.next}</span><Link href="/teacher/classes">Open class</Link></footer>
                </article>)}
              </div>
            </Panel>
            ...
            <Panel title="Students needing attention" subtitle="Generated from attendance and academic trends">
              ...
              <Link className="panel-link" href="/teacher/students">View my students →</Link>
            </Panel>
          </section>
          ...
          <section className="teacher-grid equal">
            <Panel title="Lesson plan & syllabus" subtitle="Planning and curriculum progress">
              ...
              <div className="teacher-note"><strong>Upcoming deadline</strong><p>Week 6 Mathematics lesson plan is due tomorrow at 6:00 PM.</p><Link href="/teacher/lesson-plans">Continue lesson plan</Link></div>
            </Panel>
            ...
            <Panel title="My performance" subtitle="Private professional dashboard">
              ...
              <Link className="panel-link" href="/teacher/performance">Open my performance →</Link>
            </Panel>
          </section>
        </div>
      </section>
