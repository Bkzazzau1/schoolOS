...
const meals:MealDay[]=[
  ...
  {day:"Wednesday",breakfast:"Moi-moi + pap",lunch:"Rice + stew + fish",snack:"Fruit",servings:418,status:"Serving",note:"Current service day."},
  ...
  {day:"Friday",breakfast:"Tea + bread",lunch:"Fried rice + chicken",snack:"Fruit",servings:398,status:"Planned",note:"Friday service closes earlier with school timetable."},
];
